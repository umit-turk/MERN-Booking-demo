    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <label className="text-gray-700 text-sm font-bold flex-1">
                ...
                <textarea
                    rows={10}
                    className={`border rounded w-full py-1 px-2 font-normal ${errors.description ? "border-red-500" : ""
                        }`}
            ...
            <label className="text-gray-700 text-sm font-bold max-w-[50%]">
                ...
                <input
                    type="number"
                    className={`border rounded w-full py-1 px-2 font-normal ${errors.pricePerNight ? "border-red-500" : ""
                        }`}
