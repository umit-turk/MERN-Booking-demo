                ...
                <div className="grid grid-cols-1 gap-1 items-center">
                    ...
                    <div className="flex bg-white px-2 py-1 gap-2">
                        <label className="items-center flex">
                            Adults:
                            <input type="number" className="w-full p-1 focus:outline-none font-bold" min={1} max={20} {...register("adultCount", {
                    ...
                    <div className="flex bg-white px-2 py-1 gap-2">
                        <label className="items-center flex">
                            Children:
                            <input type="number" className="w-full p-1 focus:outline-none font-bold" min={0} max={20} {...register("childCount", {
                                valueAsNumber: true
                            })} />
                        </label>
                        {errors.adultCount && (
